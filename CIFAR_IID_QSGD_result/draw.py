...
plt.plot(x[:len(quan12)], quan12, marker='*', label="Spar. with $QSGD_12$", markevery=1)
plt.plot(x[:len(quan8)], quan8, marker='*', label="Spar. with $QSGD_8$", markevery=1)
plt.plot(x[:len(quan10)], quan10, marker='*', label="Spar. with $QSGD_10$", markevery=1)
plt.plot(x[:len(quan32)], quan32, marker='*', label="Spar.", markevery=1)
