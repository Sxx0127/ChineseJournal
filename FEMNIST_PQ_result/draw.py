...
plt.plot(x, quan6, marker='+', label="Spar. with $PQ_6$", markevery=5)
plt.plot(x, quan10, marker='*', label="Spar. with $PQ_10$", markevery=2)
plt.plot(x, quan8, marker='D', label="Spar. with $PQ_8$", markevery=2)
plt.plot(x, quan32, marker='o', label="Spar.", markevery=2)
plt.plot(x, work, marker='^', label="OurWork", markevery=2)
plt.xlabel('#Rounds')
